...
def get_datasets(data_name, data_path='./external', data_config=None):
    ...
    if data_name == 'commonsenseqa':
        ...
        dev_path = '/scratch/smj490/alc-main/external/standardizedtests/standardizedtests_v1_dev.jsonl'
        test_path = '/scratch/smj490/alc-main/external/standardizedtests/standardizedtests_v1_tst.jsonl'
        train_path = '/scratch/smj490/alc-main/external/standardizedtests/standardizedtests_v1_trn.jsonl'
        datasets = {}
        datasets['dev'] = get_lines(dev_path)
        datasets['test'] = get_lines(test_path)
        datasets['train'] = get_lines(train_path)
